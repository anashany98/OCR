      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <Card>
          <CardContent className="space-y-4 pt-4">
            <form
              className="grid gap-2 md:grid-cols-[1fr_1fr_120px_140px_auto]"
        ...
        <Card>
          <CardContent className="space-y-4 pt-4">
            <form
              className="grid gap-2 md:grid-cols-[1fr_100px_100px_1fr_auto]"
              onSubmit={(e: FormEvent) => {
                e.preventDefault()
            ...
            {createNotificationRule.isError && (
              <p className="text-sm text-destructive">{createNotificationRule.error?.message}</p>
            )}
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent className="space-y-3 pt-4">
            <div className="grid gap-2 sm:grid-cols-4">
              <ConfigStatus
                ...
                tone={productionReadiness?.status === "ready" ? "success" : "warning"}
              />
          ...
          <CardContent className="pt-4">
            <div className="flex flex-wrap items-center gap-3 rounded-md border bg-slate-50 p-3">
              <Button
                type="button"
                onClick={() => {
                  if (window.confirm("¿Activar datos demo?")) seedDemo.mutate()
                }}
              ...
              <span className="text-sm text-muted-foreground">
                Crea datos de ejemplo para demo.
              </span>
