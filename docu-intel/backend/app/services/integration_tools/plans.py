...
def execute_search_plans(
    ...
    return _response(request_id, "search_plans", context, data=[_model_dict(plan) for plan in plans])
...
def execute_get_plan_rooms(
    ...
    return _response(request_id, "get_plan_rooms", context, data=[_model_dict(room) for room in rooms])
...
def execute_get_plan_dimensions(
    ...
    return _response(request_id, "get_plan_dimensions", context, data=[_model_dict(dimension) for dimension in dimensions])
...
def execute_get_room_measurements(
    ...
    return _response(request_id, "get_room_measurements", context, data=[_model_dict(room) for room in rooms])
