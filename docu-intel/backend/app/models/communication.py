...
class CommunicationThread(Base):
    ...
    messages = relationship("CommunicationMessage", back_populates="thread", cascade="all, delete-orphan")
    participants = relationship("CommunicationParticipant", back_populates="thread", cascade="all, delete-orphan")
...
class CommunicationMessage(Base):
    ...
    thread_id: Mapped[int] = mapped_column(
        ForeignKey("communication_threads.id", ondelete="CASCADE"), index=True, nullable=False,
    )
    ...
    attachments = relationship("AttachmentLink", back_populates="message", cascade="all, delete-orphan")
...
class AttachmentLink(Base):
    ...
    message_id: Mapped[int] = mapped_column(
        ForeignKey("communication_messages.id", ondelete="CASCADE"), index=True, nullable=False,
    )
...
class ProjectEvent(Base):
    ...
    source_message_id: Mapped[int | None] = mapped_column(
        ForeignKey("communication_messages.id", ondelete="SET NULL"), index=True,
    )
