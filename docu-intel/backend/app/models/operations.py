...
class WatchedFile(Base):
    ...
    events = relationship(
        "IngestionEvent", back_populates="watched_file", cascade="all, delete-orphan"
    )
...
class IngestionEvent(Base):
    ...
    watched_file_id: Mapped[int | None] = mapped_column(
        ForeignKey("watched_files.id", ondelete="SET NULL"), index=True
    )
